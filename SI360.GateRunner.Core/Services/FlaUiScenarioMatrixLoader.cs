...
public sealed class FlaUiScenarioMatrixLoader : IFlaUiScenarioMatrixLoader
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ScenarioToMethod =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Valid PIN Authenticates"] = "Sign_On_Screen_Should_Authenticate_To_Service_Profile_Or_Room_Selection",
            ["Invalid PIN Shows Feedback"] = "Invalid_Pin_Attempt_Should_Produce_Feedback_Message",
            ["PIN Clear And Backspace Work"] = "Pin_Backspace_And_Clear_Should_Update_Login_State",
            ["Select Service Profile"] = "Functional_01A_Select_Profile_Should_Show_Room_Canvas",
            ...
            ["Meal Type Dialog Completes Assignment"] = "Functional_31_Meal_Type_Selection_Should_Assign_Resident_To_Seat",
            ...
            ["Forced Modifier Selection"] = "Functional_05A_Modifier_Selection_Should_Add_Parent_And_Modifier_Rows",
            ["Modify Existing Item"] = "Functional_10C_Modify_Button_Should_Reopen_Modifiers_And_Update_Selected_Item",
            ...
            ["Select Seat For Payment"] = "Functional_23_Split_Payment_Should_Select_Seat_And_Add_Multiple_Payment_Media",
            ["Add Multiple Payment Media"] = "Functional_23_Split_Payment_Should_Select_Seat_And_Add_Multiple_Payment_Media",
            ...
            ["Supervisor PIN Grants Override"] = "Supervisor_Pin_Correct_Should_Grant_Override",
            ["Apply Discount To Check"] = "Apply_Discount_Authorized_Should_Apply_To_Check",
            ["Open Closed Checks Grid"] = "Functional_45_Closed_Check_Should_Open_Dialog_And_Expose_Grid",
            ...
            ["Sell Gift Card Dialog Opens"] = "Functional_51_Sell_Gift_Card_Should_Open_Dialog_And_Expose_Numpad",
            ["Check Gift Card Balance"] = "Functional_46_Gift_Card_Balance_Should_Open_Dialog_And_Expose_Numpad",
            ["Add Funds Card Number Step"] = "Functional_52_Add_Funds_To_Gift_Card_Should_Open_Dialog_And_Expose_Numpad",
            ["Add Funds Amount Step"] = "Functional_52_Add_Funds_To_Gift_Card_Should_Open_Dialog_And_Expose_Numpad",
            ["Redeem Gift Card From Payment"] = "Functional_47_Gift_Card_Redeem_Should_Open_Dialog_Or_Require_Payment_Context",
            ["Print Check Dialog Opens"] = "Functional_42_Print_Check_Should_Open_Dialog_And_Expose_Copy_Controls",
            ["Print Separate Checks Dialog Opens"] = "Functional_56_Print_Separate_Checks_Should_Open_Dialog_And_Expose_Print_Actions",
            ["Transfer Check Opens Employee List"] = "Functional_44_Transfer_Check_Should_Open_Dialog_And_Expose_Employee_List",
            ["Combine Check Dialog Opens"] = "Functional_33_Combine_Check_Action_Should_Open_Dialog",
            ["Reorder Confirmation Opens"] = "Functional_49_Reorder_Should_Open_Confirmation_Or_Show_Response",
            ["Order Type Dialog Opens"] = "Functional_48_Change_Order_Type_Should_Open_Dialog_And_Expose_Options",
            ["Select Order Type"] = "Functional_48_Change_Order_Type_Should_Open_Dialog_And_Expose_Options",
            ["View Open Sales Opens"] = "Functional_38_View_Open_Sales_Should_Open_Grid_Or_Empty_State",
            ["Device Cashout Report Opens"] = "Functional_39_Device_Cashout_Report_Should_Open_And_Show_Report_State",
            ["Employee Cashout Server Sales Loads"] = "Functional_50_Server_Sales_Report_Should_Open_And_Expose_Report_Grids",
            ["System Settings Opens"] = "Functional_36_System_Settings_Should_Open_And_Expose_Editable_Controls",
            ...
            ["Feedback Dialog Opens"] = "Functional_37_Send_Feedback_Should_Open_And_Expose_Form_Controls",
            ["Reset Service Profile Confirmation"] = "Functional_58_Reset_Service_Profile_Should_Open_Confirmation",
            ["Restart Confirmation Cancel"] = "Functional_59_Restart_Should_Open_Confirmation",
            ["Restart Confirm Reattaches"] = "Functional_59A_Restart_Application_Should_Confirm_And_Reattach",
            ...
            ["High Value Controls Have AutomationIds"] = "HighValueControls_ExposeStableAutomationProperties"
        };
